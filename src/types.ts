...
export interface CssClassDefinition {
 ...
 bem: BemParts | null;
 /**
  * The file whose indexing produced this definition. Differs from `filePath`
  * when positions were remapped back to their original source via a source
  * map. Used so `removeFile(compiledPath)` can still remove remapped
  * definitions when the compiled file changes or is deleted.
  */
 indexedFrom?: string;
}
